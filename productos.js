const productos = {
  "Congelados": [
    ...
    { "nombre": "Base focaccia tomate cherry (Congelada)", "dias": 180, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
    { "nombre": "Brownie (Congelado)", "dias": 180, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
    { "nombre": "Buñuelos (Congelados)", "dias": 180, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
    { "nombre": "Cebolla caramelizada (Congelada)", "dias": 180, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
    { "nombre": "Cookie vainilla (Congelada)", "dias": 180, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
    { "nombre": "Dot panadero (Congelado)", "dias": 180, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
    { "nombre": "Edamame (Mukimame) (Congelado)", "dias": 365, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
    { "nombre": "Mango dados (Congelado)", "dias": 365, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
    { "nombre": "Muffin (todos) (Congelado)", "dias": 180, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
    { "nombre": "Pan espelta rebanado (Congelado)", "dias": 90, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
    { "nombre": "Pan molde (todos) (Congelado)", "dias": 90, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
    ...
    { "nombre": "Torrija (Congelada)", "dias": 180, "tipo": "C", "estado": "Congelado (ver fecha envase)" },
  ...
  "Refrigerados": [
    { "nombre": "Aguacate pulpa (En descongelación)", "dias": 2, "tipo": "R", "estado": "En descongelación (Refrigerado)", "lote": "25080703" },
    { "nombre": "Aguacate pulpa (Abierto)", "dias": 2, "tipo": "R", "estado": "Refrigerado y abierto", "lote": "25080703" },
    { "nombre": "Pollo asado deshebrado (En descongelación)", "dias": 2, "tipo": "R", "estado": "En descongelación (Refrigerado)" },
    { "nombre": "Salmón ahumado (En descongelación)", "dias": 2, "tipo": "R", "estado": "En descongelación (Refrigerado)", "lote": "M250901L01" },
    { "nombre": "Tortilla campera (En descongelación)", "dias": 2, "tipo": "R", "estado": "En descongelación (Refrigerado)" },
    { "nombre": "Tortilla francesa (En descongelación)", "dias": 1, "tipo": "R", "estado": "En descongelación (Refrigerado)", "lote": "03082501" },
    { "nombre": "Tarta de queso (En descongelación)", "dias": 2, "tipo": "R", "estado": "En descongelación (Refrigerado)" },
    { "nombre": "Tarta mouse chocolate (En descongelación)", "dias": 2, "tipo": "R", "estado": "En descongelación (Refrigerado)" },
    { "nombre": "Tarta zanahoria flor (En descongelación)", "dias": 2, "tipo": "R", "estado": "En descongelación (Refrigerado)" },
    ...
    { "nombre": "Bacon (Sin abrir)", "dias": 0, "tipo": "R", "estado": "Sin abrir (ver fecha envase)"},
    ...
    { "nombre": "Zumo limón exprimido (Sin abrir)", "dias": 0, "tipo": "R", "estado": "Sin abrir (ver fecha envase)" },
